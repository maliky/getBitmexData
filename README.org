...
Please, just check the import section of [[https://github.com/maliky/getBitmexData][getBitmexData.py]] and install the packages you are missing, if any... and preferably in a virtual env.  I like [[https://github.com/pypa/pipenv][pipenv]]. :)
